...
const LOGIN_STYLES = `
  ...
  /* Below lg, the whole vitals/brand panel (incl. the ECG pulse line) is not
     shown — this rule guarantees the animation is fully stopped and painted
     nowhere on small screens even for a brief instant during hydration,
     which is what was causing a visible blink on mobile. */
